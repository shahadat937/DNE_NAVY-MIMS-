...
namespace RMS.BLL.IManager
{
    public interface IUserManager
    {
        ...
        ResponseModel SaveUserPrifile(UserProfile model, User model1);
        List<User> GetUsers();
        ...
        ResponseModel ResetUserPasswordTest();
        ...
        ResponseModel SessionOut(string userId);

        UserProfile FindOneProfile(long userId);
