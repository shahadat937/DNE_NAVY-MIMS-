...
namespace RMS.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IBranchInfoManager branchInfoManager, IUserLogInfoManager userLogInfoManager)
        {
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        public async Task<ActionResult> TwoFactorLogin(TwoFactorLoginViewModel model, string returnUrl)
        {

            //if (ModelState.IsValid)
            //{
            //    var user = await UserManager.GetTwoFactorEnabledAsync(model.TwoFactorEnabled);
            //    if (user != null)
            //    {
