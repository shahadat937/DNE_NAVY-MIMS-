...
{
   public class UserRightTreeView
    {
       public List<UserRightTreeView> ChildUserRight { get; set; }
       public UserRightTreeView()
       {
           this.ChildUserRight=new List<UserRightTreeView>();
       }
